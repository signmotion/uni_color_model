...
void main() {
  ...
  group('Correct, ACMYK model', () {
    ...
    test('acmykWith, depths for channel: equal 4', () {
    ...
    test('acmykWith, depths for channel: equal 12', () {
      // bin 12 000000000110 111111011110 000010100001 101100101100
    ...
    /* TODO
    test('acmykWith, depths for channel: 2:3:4:5:6', () {
